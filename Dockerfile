...
RUN apt-get update && apt-get install -y openssh-client telnet netcat iputils-ping dnsutils curl wget default-mysql-client-core traceroute vim tcpdump net-tools iproute2
